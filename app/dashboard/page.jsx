      ...
      <div className="max-w-7xl mx-auto px-4 py-6 md:py-10 lg:px-8">
        ...
        <header className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            >
              <ArrowUpDown
                className={`w-5 h-5 ${sortOrder === "asc" ? "text-blue-600" : "text-slate-600"}`}
              />
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-xl lg:shadow-md p-5 md:p-6 overflow-hidden relative">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  {uploading && (
                    <div className="mt-2 flex items-center gap-2 text-blue-500 text-xs font-medium">
                    ...
                    {form.items.length > 0 && (
                      <div className="flex flex-wrap gap-2 p-2 bg-slate-50 rounded-xl border border-slate-100">
                        {form.items.map((item, idx) => (
                          <span
                            key={idx}
                            className="inline-flex items-center gap-1.5 px-3 py-1 bg-white border border-slate-200 text-slate-700 text-xs font-bold rounded-lg shadow-sm"
                          >
                            {item}
                            <button
                              type="button"
                              onClick={() => removeFruitItem(idx)}
