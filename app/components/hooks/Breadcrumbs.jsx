...
export default function Breadcrumbs({ items = [] }) {
  return (
    <div className="w-full flex justify-center pt-4 items-center">
      <div className="w-full relative overflow-hidden max-w-7xl py-24 mt-24 rounded-2xl flex justify-center items-center shadow-xl">
        <div className="flex  justify-center text-white items-center flex-col gap-5">
          ...
          <h1 className="uppercase z-10 text-center text-5xl font-bold">
            {items.map((item) => (
              <>{item.page}</>
            ))} 
          </h1>
